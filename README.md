...
### Option 2: Use skills from the repository

The skills in `skills/prd/` and `skills/ralph/` can be used directly from this repository or copied to your preferred location.
